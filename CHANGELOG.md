# Changelog - Week of August 31, 2026
...
* Improved referral handling for concurrent webhook delivery
* Infrastructure updates for health plan routing
* Removed copy family members from appointment joining flow
...
* More reliable document validation
* Reduced logging for expected states
* User profile menu styling updates
...
* Smart filter repair capability
* Join call option on appointment status
* Message queue reliability improvements
* Infrastructure updates
* Documentation updates
* VCF file download capability
* Frontend API layer improvements
* Security configuration improvements
* Insurance feedback incentive program
...
* Authentication infrastructure updates
* API resilience improvements
* Appointment handling updates
...
* S3 storage infrastructure updates
...
* S3 storage and data migration tools
* Developer documentation
* Documentation reorganization
* Dependency cleanup
* Improved webhook handling
* Automatic referral reissue for scheduling errors
* Booking failure recovery
* Referral cache improvements
* UI timeout improvements
* Booking failure handling
* Static assets infrastructure
* Infrastructure automation improvements
* Identity verification documentation
* Dependency management and database updates
 ...
 *  Update backend for consent
 *  Update backend for third party integrations
 *  UI quality of life changes
 *  Remove specific program auto-offers
 ...
 * Change default meeting type for insurance bookings
 * Fix for consent recording
 * Improved UI error feedback
 * Internal updates
 ...
 * UI updates to prevent avoidable error states
...
## What's Changed                                                                                                                                                                                           
 * Refactor dashboard status cards                                                                                                                                                                          
...
## What's Changed                                                                                                                                                                                           
 * Release of new insurance predictor                                                                                                                                                                       
...
## What's Changed                                                                                                                                                                                           
 * Change insurance copy to Policy Number (Member ID)                                                                                                                                                       
